...
Set `WAVE_POOL_MC_SAMPLES=N` (default `100`) to control the number of Monte Carlo uncertainty samples.  Higher values give smoother 95 % confidence intervals at the cost of more CPU time.
